import { CheckCircle, Circle, DotsThreeVertical } from "phosphor-react";
...
export function MenuTask({ detailColor, setTask, task }:MenuTaskProps) {
  return (
      <Menu as="div" className="relative inline-block text-left ">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md text-black text-sm font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
